...
export class AuthController {
  ...
  @ApiResponse({
    status: 201,
    description:
      'Tenant registered successfully and default API key generated.',
  })
  ...
  @ApiResponse({
    status: 200,
    description:
      'JWT authentication tokens returned successfully (or MFA required).',
  })
  @ApiResponse({
    status: 401,
    description: 'Invalid email or password / Account locked.',
  })
  ...
  @ApiOperation({
    summary:
      'Generate Two-Factor Authentication TOTP secret and QR code data URL',
  })
  @ApiResponse({
    status: 200,
    description: 'TOTP secret and QR Code Data URI returned successfully.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'JWT authentication tokens returned successfully.',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Revoke a specific session (Log out remote device)',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Revoke all other active sessions (Log out all other devices)',
  })
  @ApiResponse({
    status: 200,
