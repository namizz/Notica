...
export function NoticaMark({ className = 'h-9 w-9' }: { className?: string }) {
  return (
    <span
      className={`public-logo-mark relative flex shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-violet-500 to-indigo-700 text-white shadow-lg shadow-violet-500/20 ${className}`}
      aria-hidden="true"
    >
...
export function PublicHeader() {
  return (
    <>
      <header className="public-header fixed inset-x-0 top-0 z-50 border-b border-white/8 bg-[#070b12]/88 shadow-lg shadow-black/10 backdrop-blur-xl">
...
export function PublicFooter() {
  return (
    <footer className="public-footer border-t border-white/5 bg-[#05080e]">
